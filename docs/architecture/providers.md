...
> **Plan:** [`docs/plans/providers-arch.md`](../plans/providers-arch.md) (the spec; this doc is the deliverable).
...
This doc is reviewable as a design artifact. The M5 implementation plan ([`docs/plans/providers-arch.md`](../plans/providers-arch.md)) tracks the code that delivers it. When M5 PRs open, their descriptions reference the section here that they implement (e.g., *"implements §5 DI wiring + §7 Linear backend"*).
